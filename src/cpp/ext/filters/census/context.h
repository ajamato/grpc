...
class CensusContext {
 public:
  ...
  explicit CensusContext(absl::string_view name, const ::opencensus::tags::TagMap& tags)
  ...
  CensusContext(absl::string_view name, const ::opencensus::trace::Span* parent, const ::opencensus::tags::TagMap& tags)
      : span_(::opencensus::trace::Span::StartSpan(name, parent)), tags_(tags) {}
 ...
 private:
  // TODO:
  // ::opencensus::context::Context context_;
